...
const siteSchema = z.object({
  ...
  defaults: z
    .object({
      ...
      defaultActionDelayMs: z.number().int().nonnegative().default(100),
      fieldDelayMs: z.number().int().nonnegative().default(250),
      clickDelayMs: z.number().int().nonnegative().default(900),
      navigationDelayMs: z.number().int().nonnegative().default(1500),
    })
    .default({}),
